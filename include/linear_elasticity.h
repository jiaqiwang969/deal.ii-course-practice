...
#ifndef LinearElasticity_include_file
#define LinearElasticity_include_file
...
/**
 * Solve the LinearElasticity problem, with Dirichlet or Neumann boundary
 * conditions, on all geometries that can be generated by the functions in the
...
protected:
  ...
  // physical parameter for linear elasticity
  double mu     = 1;
  double lambda = 1;
